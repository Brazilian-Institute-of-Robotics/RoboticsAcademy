...
import map_world from "../resources/images/world_teste_01.png";
import Vacuum from "../resources/images/my_robot.png";
...
export default function VizualizerGoal() {
  ...
  const resizeObserver = new ResizeObserver((entries) => {
    ...
    var width = (539 / 300) / (539 /img.clientWidth);
    var height = (616 / 150) / (616 /img.clientHeight);
  ...
  return (
    <div style={{display: "flex", width: "100%", height: "100%", position:"relative"}}>
      <img src={map_world} alt="" className="exercise-canvas" id="exercise-img"/>
